...
export declare class VisitorAggregation {
    ...
    protected VisitCommonArithmetic(node: Token, context: any, arithmetic: string): void;
    protected VisitAddExpression(node: Token, context: any): void;
    protected VisitSubExpression(node: Token, context: any): void;
    protected VisitMulExpression(node: Token, context: any): void;
    protected VisitDivExpression(node: Token, context: any): void;
    protected VisitModExpression(node: Token, context: any): void;
